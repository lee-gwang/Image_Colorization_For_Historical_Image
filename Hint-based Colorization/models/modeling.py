...
class IColoriT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=6, num_classes=512, embed_dim=512, depth=12,
                 num_heads=12, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
                 drop_path_rate=0., norm_layer=nn.LayerNorm, init_values=None,
                 use_rpb=False, avg_hint=False, head_mode='default', mask_cent=False, pretrained_cfg=None):
        super().__init__()
        self.num_classes = num_classes
