...
def get_args():
    ...
    parser.add_argument('--color', action='store_true', help='for recolorization')
...
if __name__ == '__main__':
    ...
    ex = gui_main.IColoriTUI(args, color_model=model, img_file=args.target_image,
                             load_size=args.input_size, win_size=1280, device=args.device)
