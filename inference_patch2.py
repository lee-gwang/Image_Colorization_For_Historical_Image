...
def valid_one_epoch(model, dataloader, device):
    ...
    #             (2, 256, 256, 0.8, 0.), (2, 384, 300, 0.8, 0.),
    #             ]


    # hp_list = [(2, 1024, 1000, 0.8, 0.3), (3, 1024, 900, 0.8, 0.3), (1, 1024, 1000, 0.8, 0.1)]

            #   (2, 1024, 1000, 0.7, 0.2), (3, 512, 500, 0.6, 0.2)] # (scale, image_size, stride, patch weight, image weight)
