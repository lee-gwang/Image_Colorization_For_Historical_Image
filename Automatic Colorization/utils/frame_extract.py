...
supported_video_ext = ('.avi', '.mp4', '.gif')
...
class FrameExtractor:
    ...
    def extract(self):
        ...
        while success:
            # Write current frame
            curr_frame_filename = osp.join(self.output_dir, "img_{:05d}{}".format(frame_cnt, self.frame_ext))
            # curr_frame_filename = osp.join(self.output_dir, "{}{}".format(frame_cnt, self.frame_ext))
...
# python ./utils/frame_extract.py --video /home/data/colorization/gif.gif --output-root /home/data/colorization/gif --sampling=-1
def main():
